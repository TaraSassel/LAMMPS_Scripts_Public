...
# Change Directory
path  = r'E:\StrainControlledCyclic\300kPa\Strain0p1' # My Desktop Dir
...
plt.text(0.09, 4.7e-5, 'Cycle 1', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#c0f6bb', alpha=0.7), size = 10)
plt.text(0.09, 4.6e-5, 'Cycle 10', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#6ceb60', alpha=0.7), size = 10)
plt.text(0.09, 4.5e-5, 'Cycle 50', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#209f14', alpha=0.7), size = 10)
plt.text(0.09, 4.4e-5, 'Cycle 100', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#0e4409', alpha=0.7), size = 10)
...
plt.ylabel('Normal strain energy ($E_{sn}$) [J]', fontsize = LBF)
