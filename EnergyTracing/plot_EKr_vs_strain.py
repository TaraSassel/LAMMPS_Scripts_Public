...
plt.text(0.8, 5.8e-9, 'Cycle 1', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#c0f6bb', alpha=0.7), size = 10)
plt.text(0.8, 5.4e-9, 'Cycle 10', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#6ceb60', alpha=0.7), size = 10)
plt.text(0.8, 5.0e-9, 'Cycle 50', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#209f14', alpha=0.7), size = 10)
plt.text(0.8, 4.6e-9, 'Cycle 100', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#0e4409', alpha=0.7), size = 10)
...
plt.ylabel('Rotational kinetric energy ($E_{kr}$) [J]', fontsize = LBF)
