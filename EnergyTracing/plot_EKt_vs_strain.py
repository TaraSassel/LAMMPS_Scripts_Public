...
tkE1 = energy_data.tkE.to_numpy().T # translational 
rkE1 = energy_data.rkE.to_numpy().T # rotational 
...
plt.plot(zstrain[0:crf100], E[0:crf100],'black',zorder = 1,alpha = 0.3)
...
plt.text(0.8, 6.0e-9, 'Cycle 1', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#c0f6bb', alpha=0.7), size = 10)
plt.text(0.8, 5.6e-9, 'Cycle 10', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#6ceb60', alpha=0.7), size = 10)
plt.text(0.8, 5.2e-9, 'Cycle 50', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#209f14', alpha=0.7), size = 10)
plt.text(0.8, 4.8e-9, 'Cycle 100', ha = 'center', va = 'center', bbox=dict(boxstyle="square", fc='#0e4409', alpha=0.7), size = 10)
...
plt.ylabel('Transitional kinetric energy ($E_{kt}$) [J]', fontsize = LBF)
