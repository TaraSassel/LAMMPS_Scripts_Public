...
# Path 
path1 = r'E:\CyclicLoading\Cyclicmean\TX200_FC0p25to0p25_amp10\merged_data'
path2 = r'E:\CyclicLoading\Cyclicmean\TX200_FC0p25to0p25_amp20\merged_data'
path3 = r'E:\CyclicLoading\Cyclicmean\TX200_FC0p25to0p25_amp40\merged_data'
path4 = r'E:\CyclicLoading\Cyclicmean\TX200_FC0p25to0p25_amp60\merged_data'
    ...
    for k in np.arange(0,N,1): 
        ...
        if pn == 3:
            if k == 0: 
                ...
                plt.arrow(strain[quater_interval*3+20], 200, amp, 0, head_width=3, head_length=0.03, linewidth=1, color=ca, length_includes_head=True)
                plt.arrow(strain[quater_interval], 200, -amp, 0, head_width=3, head_length=0.03, linewidth=1, color=ca, length_includes_head=True, zorder = 2)
                plt.text(0.2, 198, '$\epsilon_{zz}^{ampl}$', ha = 'center', va = 'top', color = ca, fontsize = 10)
