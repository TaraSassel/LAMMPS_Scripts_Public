...
wanted_data = strainInfo[strainInfo.iso_stress == 300]
...
for i, path in enumerate(paths):
    ...
    plt.plot(cycle_numbers, stress, color = colors[i], label = label_list[i], ls = ls_list[i])

# Legend
plt.legend(loc='upper center', bbox_to_anchor=(0.5, 1.35), fontsize = LGF, ncol = 3)
